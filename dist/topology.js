...
import { COLLECTIONS, TIMEOUTS } from "./vars.js";
export class TopologyManager {
    ...
    async _getConfig(url) {
        try {
            ...
            const config = await client.find({
    ...
    async getCatchupServer(excludedId, epoch) {
